...
const STORAGE_KEY = "nexvyn-ui-bookmarks"
...
export function useBookmarks() {
  ...
  useEffect(() => {
    ...
    window.addEventListener(BOOKMARKS_EVENT, handleBookmarksUpdate as EventListener)

    return () => {
      window.removeEventListener(BOOKMARKS_EVENT, handleBookmarksUpdate as EventListener)
    }
  }, [])
