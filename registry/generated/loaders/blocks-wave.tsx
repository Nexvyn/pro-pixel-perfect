...
export interface BlocksWaveLoaderProps extends Omit<ComponentProps<"svg">, "ref"> {
  /**
   * Icon size in pixels
   * @default 24
   */
 ...
 */
export function BlocksWaveLoader({ size = 24, className, ...props }: BlocksWaveLoaderProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      role="img"
      aria-label="Blocks Wave loading indicator"
      {...props}
    >
      <style
...
export default BlocksWaveLoader
