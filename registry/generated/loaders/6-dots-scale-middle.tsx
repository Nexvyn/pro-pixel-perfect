...
export interface Loader6DotsScaleMiddleProps extends Omit<ComponentProps<"svg">, "ref"> {
  /**
   * Icon size in pixels
   * @default 24
   */
 ...
 */
export function Loader6DotsScaleMiddle({
  size = 24,
  className,
  ...props
}: Loader6DotsScaleMiddleProps) {
  return (
    <svg
      width={size}
      height={size}
...
export default Loader6DotsScaleMiddle
