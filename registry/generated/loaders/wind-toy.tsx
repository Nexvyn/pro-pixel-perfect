...
export interface WindToyLoaderProps extends Omit<ComponentProps<"svg">, "ref"> {
  /**
   * Icon size in pixels
   * @default 24
   */
 ...
 */
export function WindToyLoader({ size = 24, className, ...props }: WindToyLoaderProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      role="img"
      aria-label="Wind Toy loading indicator"
      {...props}
    >
      <style
        dangerouslySetInnerHTML={{
          __html: `.spinner_SoJz{transform-origin:center;animation:spinner_YGAN 1.5s linear infinite}@keyframes spinner_YGAN{100%{transform:rotate(360deg)}}`,
        }}
      />
      <path
